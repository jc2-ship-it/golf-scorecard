...
filtered_df = df[
    ...
    (df["Course Name"] == selected_course) &
...
with left_col:
    ...
    st.markdown("""
        <div style='margin-top:20px; text-align:right;'>
            <button onclick="window.print()" style="padding:8px 14px; background:#444; color:#fff; border:none; border-radius:5px; cursor:pointer;">
                🖨️ Print Scorecard
            </button>
        </div>
